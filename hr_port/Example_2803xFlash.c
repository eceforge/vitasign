...
//   /** VITASIGN CODE **/
   ...
   int i;
   	...
   	for(i = 0; i < 500; i++) {
   		...
   		Voltage1[i] = (Voltage1[i] >> 10) + ((Voltage1[i] & 512L) != 0L);
   	}
