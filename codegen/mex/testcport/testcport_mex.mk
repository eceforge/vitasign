...
MAKEFILE = testcport_mex.mk

include testcport_mex.mki


SRC_FILES =  \
	testcport.c \
	testcport_initialize.c \
	testcport_terminate.c \
	testcport_api.c \
	testcport_mex.c

MEX_FILE_NAME_WO_EXT = testcport_mex
...
SYS_INCLUDE += -I "/home/iventio/vitasign/codegen/mex/testcport"
...
%.$(OBJEXT) : /home/iventio/vitasign/codegen/mex/testcport/%.c
	$(CC) $(CCFLAGS) "$<"



%.$(OBJEXT) : /home/iventio/vitasign/codegen/mex/testcport/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
